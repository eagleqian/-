...
#define key1	(PTB_NUM|0)
#define key2	(PTB_NUM|2)
#define key3	(PTA_NUM|2)
#define key4	(PTA_NUM|5) //定义接受高低电平的输入引脚
...
void key_init(uint_16 port_pin);//定义输入引脚key初始化函数，需要有返回值,定义为输入引脚

uint_8 key_get(uint_16 port_pin);//获取输入引脚的输入信号
