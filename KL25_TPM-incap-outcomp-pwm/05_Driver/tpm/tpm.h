...
//注意：在SD-FSL-KL25开发板中，PTB9、PTB18、PTB19已分配给三色灯,
//      PTE0、PTE1分配给UART1,PTE22、PTE23分配给UART2
//      PTA0、PTA3、PTA20分配给调试接口使用。（下面说明用[]标出）
//          每个通道的具体引脚分配如下：
//             通道                     引脚名(复用编号)
...
//-------------------TPM0通道的引脚选择---------------------
//TPM0通道0的引脚：(PTA_NUM|3),(PTC_NUM|1),(PTD_NUM|0),(PTE_NUM|24)
#define TPM0_CH0  (PTC_NUM|1) 
//TPM0通道1的引脚：(PTA_NUM|4),(PTC_NUM|2),(PTD_NUM|1),(PTE_NUM|25)
#define TPM0_CH1  (PTA_NUM|4) 
//TPM0通道2的引脚：(PTA_NUM|5),(PTC_NUM|3),(PTD_NUM|2),(PTE_NUM|29)
#define TPM0_CH2  (PTA_NUM|5) 
//TPM0通道3的引脚:(PTC_NUM|4),(PTD_NUM|3),(PTE_NUM|30)
#define TPM0_CH3  (PTC_NUM|4) 
//TPM0通道4的引脚:(PTC_NUM|8),(PTD_NUM|4),(PTE_NUM|31)
#define TPM0_CH4  (PTC_NUM|8) 
//TPM0通道5的引脚：(PTA_NUM|0),(PTC_NUM|9),(PTD_NUM|5)
#define TPM0_CH5  (PTA_NUM|0)
//-----------------------------------------------------------

//---------------TPM1通道的引脚选择----------------------
//TPM1通道0的引脚：(PTA_NUM|12),(PTB_NUM|0),(PTE_NUM|20)
#define TPM1_CH0  (PTA_NUM|12)
//TPM1通道1的引脚：(PTA_NUM|13),(PTB_NUM|1),(PTE_NUM|21)
#define TPM1_CH1  (PTA_NUM|13)  
//-------------------------------------------------------

//------------------TPM2通道的引脚选择-------------------
//TPM2通道0的引脚：(PTA_NUM|1),(PTB_NUM|2)
#define TPM2_CH0  (PTB_NUM|18)
//TPM2通道1的引脚：(PTA_NUM|2),(PTB_NUM|3)
#define TPM2_CH1  (PTB_NUM|19)
//-------------------------------------------------------
